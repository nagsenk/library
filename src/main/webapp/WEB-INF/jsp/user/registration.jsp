...
<form class="myform"  action="/member/save" method="post"> 


 <table> 
 <tr><td><b></b></td>
	<td> <input  type="hidden" class="inputvalues"  name="memid" pattern="^[A-Z a-z" "]+" required placeholder=""> </td></tr>
 
    
     <tr><td><b>Firstname:</b></td>
	<td> <input  type="text" class="inputvalues"  name="firstname" pattern="^[A-Z a-z" "]+" required placeholder=" Firstname"> </td></tr>

<tr><td><b>Lastname:</b></td>
	<td> <input  type="text" class="inputvalues"  name="lastname" pattern="^[A-Z a-z" "]+" required placeholder=" Lastname"> </td></tr>
<tr><td><b>Address:</b></td>
	<td> <input  type="text" class="inputvalues"  name="address" pattern="^[A-Z a-z" "]+" required placeholder="address"> </td></tr>


	     <tr><td><b>Username:</b></td>
	<td> <input  type="text" class="inputvalues"  name="username" pattern="^[A-Z a-z" "]+"  placeholder="Username"> </td></tr>
